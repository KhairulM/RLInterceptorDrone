...
All the environments are registered in the `RLInterceptorDrone` extension. They start
...
import RLInterceptorDrone.tasks  # noqa: F401


def main():
    """Print all environments registered in `RLInterceptorDrone` extension."""
